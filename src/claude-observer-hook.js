...
export const claudeObserverEnvironment=environment=>clean(environment,/^(?:CLAUDECODE$|CLAUDE_CODE_ENTRYPOINT$|ANTHROPIC_|AWS_|GOOGLE_|GCLOUD_|CLOUD_ML_|VERTEX_REGION_|AZURE_|OPENAI|CODEX_API_KEY|CODEX_HOME$|CLAUDE_CODE_USE_)/iu);
export const codexObserverEnvironment=environment=>clean(environment,/^(?:CLAUDE|ANTHROPIC_|AWS_|GOOGLE_|GCLOUD_|CLOUD_ML_|VERTEX_REGION_|AZURE_|OPENAI|CODEX_API_KEY)/iu);
