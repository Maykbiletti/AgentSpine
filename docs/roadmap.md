...
- low-risk behavior Canaries require content-free projection and matching model-stop delivery receipts from distinct consumed-preflight turns before after-results can validate them;
