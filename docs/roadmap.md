...
- renewal precommits the first completed exact-scope turns and deterministic evaluator-root slots under the unchanged contract; later substitute turns, timestamps, replayed measurements and model assertions cannot extend evidence;
